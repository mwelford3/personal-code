...
print(df.head())
data = {'from':['Executive Director (Harriet)', 'Executive Director (Harriet)', 'Vice President (Sarah)', 'Vice President (Sarah)', 'Vice President (Charlotte)'],
        'to':['Vice President (Sarah)', 'Vice President (Charlotte)', 'Program Officer (Sojourner)', 'Program Officer (Elizabeth)', 'Program Associate (Ellen)']}

data = pd.DataFrame(data)

data = [{'data': {'source' : x, 'target': y}} for (x,y) in zip(data['from'], data['to'])]
